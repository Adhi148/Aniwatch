...
const AnimeList = () => {
    ...
    useEffect(() => {
        axios   
            .get(`https://kitsu.io/api/edge/anime?page[limit]=20&page[offset]=${page}`)
            .then((response: any) => {
                                        ...
                                        <div className="top10" key={index}>
                                            ...
                                            <div className="count_anime">
                                                ...
                                                <div className="right-title">
                                                    <div className="rightttitle">
                                                        <NavLink to={`/Posterinfo/${ele.attributes.titles.en_jp}`} style={{ cursor: "pointer", textDecoration: "none" , color:"white"}} className="top10_navigate" state={ele.attributes}>
                                                            {ele.attributes.titles.en_jp}
                                                        </NavLink>
                                                    </div>
                            ...
                            <div className="right-bottom-genre-content">
                                <div className="cbox cbox-genres">
                                    <ul className="ulclear color-list sb-genre-list sb-genre-less" style={height}>
                                        ...
                                        <NavLink to={`/Tvpage/${"Super natural"}`} className={"navlink_ani"}  style={{ color: "#ccabda" , cursor:"pointer" }}>Super Power</NavLink>
